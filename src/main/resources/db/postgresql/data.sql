-- Insert into roles
INSERT INTO watchlist.roles (rol_id, rol_name) VALUES 
(1, 'ADMIN'), 
(2, 'USER');

-- Insert into users
INSERT INTO watchlist.users (username, password, email, roles_rol_id) VALUES 
...
-- Insert into films
INSERT INTO watchlist.films (title, release_date) VALUES 
...
-- Insert into dnis
INSERT INTO watchlist.dnis (number, front_img, back_img, users_user_id) VALUES 
('12345678Z', './front.jpg', './back.jpg', 1);

-- Insert into users_haswatched_films
INSERT INTO watchlist.users_haswatched_films (users_user_id, films_film_id) VALUES 
(2, 4);
